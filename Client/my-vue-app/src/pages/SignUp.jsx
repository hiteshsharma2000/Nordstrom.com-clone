 ...
 console.log(registeruser);
  ...
  return (
    ...
    <br /> <label htmlFor="Email">Email:</label> <br />
      ...
      <div className="flex "><input type="checkbox" className="w-[1rem]"/><p className="ml-[1%]">Keep me Signed in</p></div>
      <div className="text-[.9rem]" ><p>By creating an account, you agree to our <span className="span">Privacy Policy</span> <br />and <span className="span" >Terms & Conditions.</span></p></div>
      <button

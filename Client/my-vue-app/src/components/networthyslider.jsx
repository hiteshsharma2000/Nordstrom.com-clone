      ...
      >
        <Slider>
          <Slide index={0}>
            <div className="w-[100%] block sm:flex md:flex lg:flex">
              <img
                ...
                src="https://n.nordstrommedia.com/it/0b9f3f56-938e-489a-b930-9c547bc3a731.jpeg?h=700&w=1608"
                alt=""
              />
          ...
          <Slide index={1}>
            <div className="w-[100%] block sm:flex md:flex lg:flex">
              <img
                className="md:absolute sm:absolute lg:absolute"
                src="https://n.nordstrommedia.com/it/b1141cdd-95a0-4be6-9fc0-d0f85d79e151.jpeg?h=700&w=1608"
                alt=""
              />
